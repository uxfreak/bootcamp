...
if(title){if(title!=="null"){$('#map_canvas').attr('data-color',title);googleMap();}}}
...
return null;}
window.onload=function(e){var cookie=readCookie("style");var title=cookie?cookie:getPreferredStyleSheet();setActiveStyleSheet(title);if(title!='null'){$('.color-settings a').removeClass("selected");$('.color-settings .color_'+ title).addClass("selected");}}
